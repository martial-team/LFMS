...
<body class="<?php echo e($themeColor); ?>">
    ...
    <?php if($message = Session::get('error')): ?>
        <script>
            show_toastr('<?php echo e(__('Error')); ?>', '<?php echo $message; ?>', 'errousers-listr')
        </script>
    <?php endif; ?>

    <script>
        window.currentLocale = '<?php echo e(App::getLocale()); ?>';
    </script>
    <script>
...
<?php /**PATH /home/user/Downloads/advocategosaas-21nulled/codecanyon-46105956-advocatego-saas-legal-practice-management/main-file/resources/views/layouts/app.blade.php ENDPATH**/ ?>