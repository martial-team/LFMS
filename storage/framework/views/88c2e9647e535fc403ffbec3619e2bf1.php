                ...
                <li class="dropdown dash-h-item drp-company">
                    <a class="dash-head-link dropdown-toggle arrow-none me-0 " data-bs-toggle="dropdown" href="#"
                        ...
                        <span class="theme-avtar">
                            <?php if(Request::segment(1) == 'chats' ): ?>
                                <img alt="#" style="width:30px;"
                                src="<?php echo e(!empty(\Auth::user()->avatar) ? $logo. basename(\Auth::user()->avatar) : $logo . '/avatar.png'); ?>"
                                class="header-avtar">
                            <?php else: ?>
                                <img alt="#" style="width:30px;"
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/user/Downloads/advocategosaas-21nulled/codecanyon-46105956-advocatego-saas-legal-practice-management/main-file/resources/views/partision/header.blade.php ENDPATH**/ ?>